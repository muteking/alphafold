...
测试 FASTA 文件已创建：
```bash
/home/mutek/alphafold/test_protein.fasta
```

测试脚本已创建：
```bash
/home/mutek/alphafold/test_alphafold_arm64.sh
```
...
python3 /home/mutek/alphafold/docker/run_docker.py \
    --fasta_paths=/home/mutek/alphafold/test_protein.fasta \
...
| 参数 | 说明 | 示例 |
|------|------|------|
| `--fasta_paths` | 蛋白质序列 FASTA 文件 | `/home/mutek/alphafold/test_protein.fasta` |
...
python3 docker/run_docker.py \
  --fasta_paths=/home/mutek/alphafold/test_protein_with_pdb.fasta \
